...
const AddMember = () => {
  ...
  useEffect(() => {
    if (formikStep1.values.ProjectName && seniorityInput) {
      const selectedProject = projects.find(p => p.name === formikStep1.values.ProjectName);
      if (selectedProject) {
  ...
  const formikStep3 = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      // Combine all form data and map to backend schema with proper data formatting
      const finalData = {
      ...
      try {
        ...
        const response = await axios.post(
          "https://navagara-backend.onrender.com/add-members",
          formData,
          {
        ...
        <div className="w-full max-w-4xl">
              ...
              <div className="flex flex-col items-center">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center font-semibold text-lg transition-all duration-300 ${
                    currentStep >= 1
                      ? "bg-[#7C66CA] text-white"
                      : "bg-[#C9BFF0] text-white"
                  }`}
                >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div className="">
                  ...
                  <label
                    htmlFor="imageUpload"
                    className="flex items-center justify-between gap-3 border border-gray-300 px-4 py-2.5 w-full bg-white rounded text-[16px] cursor-pointer hover:bg-gray-50 hover:border-blue-400 transition-colors"
                  >
          ...
          {currentStep === 2 && (
            <form
              ...
              className="border-4 border-blue-400 rounded-lg p-8 bg-white"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                {/* Aadhar Number */}
                <div>
