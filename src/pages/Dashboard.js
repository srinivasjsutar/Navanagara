 ...
 const groupByMonthly = (data, amountField = null) => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((error) => {
        console.error("There was error while fetching the Members!", error);
      });
  }, []);
  ...
  useEffect(() => {
    axios
      ...
      .catch((error) => {
        console.error(
          "There is some error while fetching the receipts!.",
          error,
        );
      });
  }, []);
  ...
  return (
    <div>
          ...
          {/* <div className="lg:w-[235px] lg:h-[119px] bg-[#7C66CA] rounded-xl">
            <div className="px-[20px] flex py-[16px]">
              ...
              <div className="px-[20px]">
                ...
                <div className="font-bold text-[30px] text-white">
                  ₹{Number(filteredData.amount || 0).toLocaleString()}
                </div>
                <p className="text-[14px] text-white">
                  {selectedMonth === "all"
                    ? "All Time"
      ...
      <div className="flex">
        {/* <InvoiceStatistics
          totalAmount={invoiceStats.total}
          paidAmount={invoiceStats.paid}
          overdueAmount={invoiceStats.overdue}
        /> */}
        <BookingOverview />
      </div>
      <div>
