    ...
    <div>
      ...
      <div className="flex gap-[56px] px-[100px]">
        <div className="flex flex-col justify-center items-center text-center lg:w-[452px] lg:h-[307px] border-1 p-[24px] rounded-3xl border-[#7C66CA]">
          ...
          <Link to='/memberlist' className="no-underline text-[16px] text-[#FFFF00] bg-[#7C66CA] py-[8px] px-[70px] rounded-full font-semibold mt-3 flex">
        ...
        <div className="flex flex-col justify-center items-center text-center lg:w-[452px] lg:h-[307px] border-1 p-[24px] rounded-3xl border-[#7C66CA]">
          ...
          <Link to="/sitebookinglist" className="no-underline text-[16px] text-[#FFFF00] bg-[#7C66CA] py-[8px] px-[70px] rounded-full font-semibold mt-3 flex">
            View Report <ChevronRight />
          </Link>
        </div>
      </div>
      <div className="flex mt-[38px] mb-5 mx-[100px] flex-col justify-center items-center text-center lg:w-[452px] lg:h-[307px] border-1 p-[24px] rounded-3xl border-[#7C66CA]">
        ...
        <Link to="/receiptlist" className="no-underline text-[16px] text-[#FFFF00] bg-[#7C66CA] py-[8px] px-[70px] rounded-full font-semibold mt-3 flex">
          View Report <ChevronRight />
        </Link>
      </div>
    </div>
